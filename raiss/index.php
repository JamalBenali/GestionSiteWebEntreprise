        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="active">
                    ...
                    <a href="../baramij" data-toggle="collapse" aria-expanded="false">
                        <i class="glyphicon glyphicon-home"></i>
                        Baramij
                    </a>
                    <a href="../contactUs" data-toggle="collapse" aria-expanded="false">
                        <i class="glyphicon glyphicon-home"></i>
                        Itassil Bina
                    </a>
